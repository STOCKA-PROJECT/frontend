...
<template>
  ...
  >
    <template v-if="name === 'box'">
      <path d="M3 7v10a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 17V7a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 7Z" />
    ...
    <template v-else-if="name === 'folder'">
      <path d="M22 12H2" />
      <path d="M5 5h14l3 7v7a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-7z" />
    </template>
    <template v-else-if="name === 'door'">
      <rect x="3" y="3" width="18" height="18" rx="2" />
      <path d="M9 3v18" />
    </template>
    <template v-else-if="name === 'cabinet'">
